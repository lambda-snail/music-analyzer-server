...
LambdaSnail::music::models::user_details_model::user_details_model(application::Session& session)
  : WFormModel(),
    m_session(session)
{
...
void LambdaSnail::music::models::user_details_model::save(Wt::Auth::User const& auth_user)
{
